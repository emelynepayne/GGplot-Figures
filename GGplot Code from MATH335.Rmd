...
This document contains all the code I used to generate the images for John Rauser's presentation How Humans See Data, first presented at [Velocity Amsterdam 2016](http://conferences.oreilly.com/velocity/devops-web-performance-eu/public/schedule/detail/54354).  This document is not meant to stand alone -- it has very little explanatory text.  It is meant to be a reference for people who want to see how I made the plots from the presentation. 
